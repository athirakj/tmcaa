  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
                  <button style="margin-bottom:10px;" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> Edit Profile</button>
          ...
          <button class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> Logout</button>
        </div>      
      </div>
      <br>
